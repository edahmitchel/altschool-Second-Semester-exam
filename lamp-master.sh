...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=tonies/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=tonies/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=toni@2020/' /var/www/html/laravel/.env
